 ...
 * @since 1.0.0
 */
public class CreateHotTopicRequest {
    ...
    // 构造函数
    public CreateHotTopicRequest() {}

    public CreateHotTopicRequest(String name, Integer popularity, Boolean visible) {
        this.name = name;
